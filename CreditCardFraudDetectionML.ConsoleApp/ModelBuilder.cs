...
namespace CreditCardFraudDetectionML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\mhabi\Desktop\creditcard.csv";
        private static string MODEL_FILEPATH = @"../../../../CreditCardFraudDetectionML.Model/MLModel.zip";
